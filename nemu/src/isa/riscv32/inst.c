...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 011 ????? 11100 11", csrrs  , I, vaddr_t* csr=CSR(imm);R(rd)=*(csr);*(csr)&=(~src1));
  /*-------R-------*/
  ...
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall  , N, assert(0);bool success;s->dnpc = (isa_raise_intr(isa_reg_str2val("a7", &success), s->pc)); );//跳转到异常入口地址
